...
# dest_url = 'http://www.pbc.gov.cn/goutongjiaoliu/113456/113469/index.html'
...
content = r.get(host_url+dynamicurl).content.decode('utf-8')

bs = BeautifulSoup(content, 'html.parser')
res = bs.find_all('a')

# res = re.findall(r'\d+/index.html', content)

# for item in res:
#     url = item['href'].strip()
#     if 'http' not in url:
#         url = ''.join([host_url, url])
#     print(url)
#     print(r.get(url).content.decode('utf-8'))



# 最后验证是否爬取到有效信息
if u'中国人民银行金融研究所博士后科研流动站2018' in content:
    print('success')
